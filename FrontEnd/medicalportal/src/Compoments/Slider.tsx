      ...
      <div className="row align-items-center">
        <div className="col-lg-4 col-sm-6">
          <div className="about-img">
            <img src="images/about/img-1.jpg"  className="img-fluid" />
            <img src="images/about/img-2.jpg"  className="img-fluid mt-4" />
          </div>
        </div>
        <div className="col-lg-4 col-sm-6">
          <div className="about-img mt-4 mt-lg-0">
            <img src="images/about/img-3.jpg" className="img-fluid" />
          </div>
        </div>
        ...
        <div className="col-lg-12 testimonial-wrap-2">
          <div className="testimonial-block style-2  gray-bg">
            ...
            <div className="testimonial-thumb">
              <img src="images/team/test-thumb1.jpg" className="img-fluid" />
            </div>
          ...
          <div className="testimonial-block style-2  gray-bg">
            <div className="testimonial-thumb">
              <img src="images/team/test-thumb2.jpg"  className="img-fluid" />
            </div>
            <div className="client-info">
          ...
          <div className="testimonial-block style-2  gray-bg">
            <div className="testimonial-thumb">
              <img src="images/team/test-thumb3.jpg"  className="img-fluid" />
            </div>
            <div className="client-info">
              <h4>Good Support!</h4>
          ...
          <div className="testimonial-block style-2  gray-bg">
            <div className="testimonial-thumb">
              <img src="images/team/test-thumb4.jpg"  className="img-fluid" />
            </div>
            <div className="client-info">
