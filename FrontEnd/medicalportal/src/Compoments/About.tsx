    ...
    <div className="container">
      <div className="row">
        ...
        <div className="col-lg-8">
          ...
          <img src="images/about/sign.png" className="img-fluid" />
        </div>
      </div>
    </div>
  </section>
      ...
      <div className="row">
        <div className="col-lg-3 col-md-6">
          <div className="about-block-item mb-5 mb-lg-0">
            <img src="images/about/about-1.jpg"  className="img-fluid w-100" />
        ...
        <div className="col-lg-3 col-md-6">
          <div className="about-block-item mb-5 mb-lg-0">
            <img src="images/about/about-2.jpg"  className="img-fluid w-100" />
        ...
        <div className="col-lg-3 col-md-6">
          <div className="about-block-item mb-5 mb-lg-0">
            <img src="images/about/about-3.jpg"  className="img-fluid w-100" />
        ...
        <div className="col-lg-3 col-md-6">
          <div className="about-block-item">
            <img src="images/about/about-4.jpg" className="img-fluid w-100" />
      ...
      <div className="row align-items-center">
        ...
        <div className="col-lg-8">
          <div className="row">
            ...
            <div className="col-lg-4 col-md-6 col-sm-6">
              <div className="award-img">
                <img src="images/about/4.png"  className="img-fluid" />
              </div>
            </div>
            <div className="col-lg-4 col-md-6 col-sm-6">
              <div className="award-img">
            ...
            <div className="col-lg-4 col-md-6 col-sm-6">
              <div className="award-img">
                <img src="images/about/2.png"  className="img-fluid" />
              </div>
            </div>
            <div className="col-lg-4 col-md-6 col-sm-6">
              <div className="award-img">
                <img src="images/about/5.png"  className="img-fluid" />
              </div>
            </div>
            <div className="col-lg-4 col-md-6 col-sm-6">
              <div className="award-img">
                <img src="images/about/6.png"  className="img-fluid" />
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="row">
        <div className="col-lg-3 col-md-6 col-sm-6">
          <div className="team-block mb-5 mb-lg-0">
            <img src="images/team/1.jpg" className="img-fluid w-100" />
        ...
        <div className="col-lg-3 col-md-6 col-sm-6">
          <div className="team-block mb-5 mb-lg-0">
            <img src="images/team/2.jpg" className="img-fluid w-100" />
            <div className="content">
        ...
        <div className="col-lg-3 col-md-6 col-sm-6">
          <div className="team-block mb-5 mb-lg-0">
            <img src="images/team/3.jpg"  className="img-fluid w-100" />
            <div className="content">
        ...
        <div className="col-lg-3 col-md-6 col-sm-6">
          <div className="team-block">
            <img src="images/team/4.jpg"  className="img-fluid w-100" />
            <div className="content">
